module Spree
  module MiniApp
    ...
    # ACLEDA (server-to-server) POSTs { phone, first_name, last_name }, HMAC-SHA256
    # signed via the X-Acleda-Signature header; we return a session-based
    # miniAppUrl for ACLEDA to open in the WebView.
    class AcledasController < Spree::Api::V2::BaseController
      ...
      def create
        result = ::Vpago::AcledaMiniApp::Session::Create.call(
          ...
          hash: request.headers['X-Acleda-Signature']
        )
